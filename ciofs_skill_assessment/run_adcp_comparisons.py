...
def rotate_to_dominant_direction(dsm2):
    ...
    try:
        ...
        dsm2[dsm2.cf["east"]] = dsm2.cf["east"]*np.nan
        dsm2[dsm2.cf["north"]] = dsm2.cf["north"]*np.nan
        dsm2[dsm2.cf["east"]].attrs["angle_degrees_xaxis"] = np.nan
        dsm2[dsm2.cf["north"]].attrs["angle_degrees_xaxis"] = np.nan
...
vocab_labels = {"east": "Along-channel velocity [m/s]",
"north": "Across-channel velocity [m/s]",
"speed": "Horizontal speed [m/s]",
# "east": "Eastward velocity [m/s]",
# "north": "Northward velocity [m/s]",
}
